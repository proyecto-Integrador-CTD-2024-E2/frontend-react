...
const ProductCard = ({producto}) => {
    ...
    return (
        <div className="card bg-white border-dark p-4 rounded overflow-hidde " style={{maxHeight: '70vh', maxWidth: '300px'}}>
            ...
            <div className="card-body  d-flex flex-column justify-content-between">
                <div>
                    ...
                    <p className="card-text text-secondary">{producto.description.substring(0, 30)}{producto.description.length >30 ? '...' : ''}</p>
                </div>
                <h2>
                    ${producto.price}
                </h2>
